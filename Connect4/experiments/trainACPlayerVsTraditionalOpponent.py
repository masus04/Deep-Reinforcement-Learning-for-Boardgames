...
from Connect4.players.basePlayers import RandomPlayer, NovicePlayer, ExperiencedPlayer
from Connect4.players.acPlayer import FCACPlayer, ConvACPlayer
from Connect4.environment.game import Connect4
from Connect4.environment.evaluation import evaluate_against_base_players, format_overview
from plotting import Printer


class TrainACPlayerVsTraditionalOpponent(Connect4BaseExperiment):
    ...
    def run(self, lr, batch_size, silent=False):
        ...
        if self.opponent is not None:
            ...
            self.simulation = Connect4([self.player1, self.player2])
...
if __name__ == '__main__':
    ...
    for i in range(ITERATIONS):
        ...
        GAMES = 1000000
        EVALUATIONS = 1000
        LR = uniform(5e-5, 1e-5)  # random()*1e-9 + 1e-5
        BATCH_SIZE = 1
