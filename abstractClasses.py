...
class LearningPlayer(Player):
    ...
    def __str__(self):
        return "[%s lr:%s width:%s]" % (self.__class__.__name__, self.strategy.lr, self.model.intermediate_size if self.model.intermediate_size is not None else self.model.conv_channels)
